import{_ as a,c as n,a5 as p,o as i}from"./chunks/framework.KBT3hDmv.js";const u=JSON.parse('{"title":"Solar Dynamics Observatory","description":"","frontmatter":{},"headers":[],"relativePath":"tutorials/solar_dynamics_observatory.md","filePath":"tutorials/solar_dynamics_observatory.md","lastUpdated":null}'),e={name:"tutorials/solar_dynamics_observatory.md"};function l(t,s,c,o,r,d){return i(),n("div",null,s[0]||(s[0]=[p(`<h1 id="Solar-Dynamics-Observatory" tabindex="-1">Solar Dynamics Observatory <a class="header-anchor" href="#Solar-Dynamics-Observatory" aria-label="Permalink to &quot;Solar Dynamics Observatory {#Solar-Dynamics-Observatory}&quot;">​</a></h1><p>First, we download the Kerchunk catalog:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> Downloads</span></span>
